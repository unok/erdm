...
// Code generated by /tmp/go-build112721477/b001/exe/peg internal/parser/parser.peg DO NOT EDIT.
...
func (p *Parser) Execute() {
	...
	for _, token := range p.Tokens() {
		...
		case ruleAction17:
			p.setIndexName(text)
		case ruleAction18:
			p.setIndexColumn(text, begin, buffer)
		case ruleAction19:
			p.setIndexColumn(text, begin, buffer)
		case ruleAction20:
			p.setUniqueIndex()
	...
	_rules = [...]func() bool{
		...
		func() bool {
			position382, tokenIndex382 := position, tokenIndex
			{
				...
				add(rulecardinality_right, position383)
			}
			return true
		l382:
		...
		func() bool {
			position384, tokenIndex384 := position, tokenIndex
			{
				...
				add(rulecardinality_left, position385)
			}
			return true
		l384:
		...
		func() bool {
			...
			l392:
				add(rulecardinality, position387)
			}
			return true
		l386:
		...
		/* 54 Action18 <- <{p.setIndexColumn(text, begin, buffer)}> */
		func() bool {
			{
		...
		/* 55 Action19 <- <{p.setIndexColumn(text, begin, buffer)}> */
		func() bool {
			{
		...
		/* 59 Action23 <- <{ p.markGroupsDecl(begin, buffer) }> */
		func() bool {
			{
